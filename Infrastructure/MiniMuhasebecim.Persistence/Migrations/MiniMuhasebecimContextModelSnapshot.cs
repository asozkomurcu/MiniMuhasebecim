...
namespace MiniMuhasebecim.Persistence.Migrations
{
    ...
    partial class MiniMuhasebecimContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniMuhasebecim.Domain.Entities.Wholesaler", b =>
                {
                    b.HasOne("MiniMuhasebecim.Domain.Entities.Category", "Category")
                        .WithMany("Wholesalers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("WHOLESALER_CATEGORY_CATEGORY_ID");
